...
// const ratelimit = require("express-rate-limit");
 ...
 const createAddRoutes = require("../Routes/createAddRoutes")
// const globalErrorHandleRoutes = require("../Controller/errorController");
...
// app.use(fileupload());
app.get("/", (req, res) => {
  res.send("welcome to helpify backend");
});
